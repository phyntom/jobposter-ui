    ...
    <section className='py-4'>
      <div className='container-xl lg:container m-auto'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg'>
          <CustomCard
            cardClassName='dark:bg-secondary bg-accent-400 text-foreground text-xl border shadow-[6px_10px_2px_1px_rgba(0,0,0,0.90)]'
          ...
          />
          <CustomCard
            cardClassName='text-xl shadow-lg border'
