        ...
        >
          ...
          <div className='flex flex-wrap items-center gap-4'>
            <Input
              ...
              placeholder='Enter company bame'
              radius='none'
              isInvalid={errors?.company?.name?.message !== undefined}
              errorMessage={
            ...
            <Input
              ...
              radius='md'
              variant='bordered'
              isInvalid={errors?.company?.website?.message !== undefined}
              errorMessage={
                errors?.company?.website?.message !== undefined
                  ? (errors?.company?.website?.message as string)
                  : ''
              }
              className='flex-1'
            />
          ...
          <div className='flex flex-wrap items-center gap-4'>
            <Input
              ...
              radius='md'
              variant='bordered'
              isInvalid={errors?.company?.contactEmail?.message !== undefined}
              errorMessage={
                errors?.company?.contactEmail?.message !== undefined
                  ? (errors?.company?.contactEmail?.message as string)
                  : ''
              }
              className='flex-1'
            />
            <Input
              ...
              // isInvalid={errors?.company?.contactPhone?.message !== undefined}
              // errorMessage={
              //   errors?.company?.contactPhone?.message !== undefined
              //     ? (errors?.company?.contactPhone?.message as string)
              //     : ''
              // }
              className='flex-1'
            />
          ...
          <Textarea
            ...
            // isInvalid={errors?.company?.description?.message !== undefined}
            // errorMessage={
            //   errors?.company?.description?.message !== undefined
            //     ? (errors?.company?.description?.message as string)
            //     : ''
            // }
          />
